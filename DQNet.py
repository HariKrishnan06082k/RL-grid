...
ap.add_argument("-p","--plot_heatmap",required=False,default=1,help="optional argument to plot learned q values heatmap (1-Yes)",type=int)
...
ap.add_argument("-i","--num_eps",required=False,default=600, help = "Number of episodes to train the policy for ",type=int)
...
if __name__ == '__main__':
    ...
    if args["train_mode"] == 1:
        ...
        #load saved model 
        target_net = DQN(n_observations, n_actions).to(device)
        target_net.load_state_dict(torch.load(args["output_path"] + 'target_model.pth'))
